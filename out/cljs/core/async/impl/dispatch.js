...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13396 = 0;while(true){
var m_13397 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13397 == null))
{} else
{m_13397.call(null);
if((count_13396 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13398 = (count_13396 + 1);
count_13396 = G__13398;
continue;
}
} else
{}
