...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16364 = (0);while(true){
var m_16365 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16365 == null))
{} else
{m_16365.call(null);
if((count_16364 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16366 = (count_16364 + (1));
count_16364 = G__16366;
continue;
}
} else
{}
