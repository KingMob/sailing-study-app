...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16370 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16370 = (function (val,box,meta16371){
this.val = val;
this.box = box;
this.meta16371 = meta16371;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t16370.cljs$lang$type = true;
cljs.core.async.impl.channels.t16370.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16370";
cljs.core.async.impl.channels.t16370.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opt__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/t16370");
});
cljs.core.async.impl.channels.t16370.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16370.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16372){var self__ = this;
var _16372__$1 = this;return self__.meta16371;
});
cljs.core.async.impl.channels.t16370.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16372,meta16371__$1){var self__ = this;
var _16372__$1 = this;return (new cljs.core.async.impl.channels.t16370(self__.val,self__.box,meta16371__$1));
});
cljs.core.async.impl.channels.__GT_t16370 = (function __GT_t16370(val__$1,box__$1,meta16371){return (new cljs.core.async.impl.channels.t16370(val__$1,box__$1,meta16371));
});
}
return (new cljs.core.async.impl.channels.t16370(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj16374 = {};return obj16374;
})();
...
{}
while(true){
var taker_16375 = self__.takes.pop();if((taker_16375 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16375))
{var take_cb_16376 = cljs.core.async.impl.protocols.commit.call(null,taker_16375);var val_16377 = (cljs.core.truth_((function (){var and__3548__auto__ = self__.buf;if(cljs.core.truth_(and__3548__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3548__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16376,val_16377,taker_16375,this$__$1){
return (function (){return take_cb_16376.call(null,val_16377);
});})(take_cb_16376,val_16377,taker_16375,this$__$1))
);
} else
{}
{
...
{} else
{var putter_16378 = self__.puts.pop();if((putter_16378 == null))
{} else
{var put_handler_16379 = putter_16378.handler;var val_16380 = putter_16378.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_16379))
{var put_cb_16381 = cljs.core.async.impl.protocols.commit.call(null,put_handler_16379);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_16381,put_handler_16379,val_16380,putter_16378,_,retval,this$__$1){
return (function (){return put_cb_16381.call(null,true);
});})(put_cb_16381,put_handler_16379,val_16380,putter_16378,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_16380)))
...
{var taker_16382 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16382))
{var take_cb_16383 = cljs.core.async.impl.protocols.commit.call(null,taker_16382);var val_16384__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16383,val_16384__$1,taker_16382,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_16383.call(null,val_16384__$1);
});})(take_cb_16383,val_16384__$1,taker_16382,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_16385 = self__.puts.pop();if((putter_16385 == null))
{} else
{var put_handler_16386 = putter_16385.handler;var val_16387 = putter_16385.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_16386))
{var put_cb_16388 = cljs.core.async.impl.protocols.commit.call(null,put_handler_16386);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_16388,put_handler_16386,val_16387,putter_16385,this$__$1){
return (function (){return put_cb_16388.call(null,true);
});})(put_cb_16388,put_handler_16386,val_16387,putter_16385,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__16393 = null;
var G__16393__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e16391){var t = e16391;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__16393__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e16392){var t = e16392;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__16393 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__16393__1.call(this,buf__$1);
case 2:
return G__16393__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__16393.cljs$core$IFn$_invoke$arity$1 = G__16393__1;
