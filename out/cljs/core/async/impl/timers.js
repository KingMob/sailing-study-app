...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13303 = 0;while(true){
if((i_13303 < arr.length))
{(arr[i_13303] = null);
{
var G__13304 = (i_13303 + 1);
i_13303 = G__13304;
continue;
}
} else
...
{var i_13310 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13312 = 0;while(true){
if((i_13312 <= self__.level))
{var links_13313 = (update[i_13312]).forward;if(((links_13313[i_13312]) === x__$1))
{(links_13313[i_13312] = (x__$1.forward[i_13312]));
{
