...
{{
var G__13792 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13792;
continue;
}
} else
...
{var pred__13796 = cljs.core._EQ_;var expr__13797 = limit;if(cljs.core.truth_(pred__13796.call(null,(1),expr__13797)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13796.call(null,(2),expr__13797)))
...
var G__13799 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13800 = (limit__$1 - (1));
var G__13801 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13799;
limit__$1 = G__13800;
parts = G__13801;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13803 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13803))
{var replacement_13804 = temp__4124__auto___13803;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13804)));
} else
{buffer.append(ch);
}
{
var G__13805 = (index + (1));
index = G__13805;
continue;
}
}
