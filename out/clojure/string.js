...
{{
var G__10385 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10385;
continue;
}
} else
...
{var pred__10389 = cljs.core._EQ_;var expr__10390 = limit;if(cljs.core.truth_(pred__10389.call(null,1,expr__10390)))
...
var G__10392 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10393 = (limit__$1 - 1);
var G__10394 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10392;
limit__$1 = G__10393;
parts = G__10394;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10396 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10396))
{var replacement_10397 = temp__4090__auto___10396;buffer.append([cljs.core.str(replacement_10397)].join(''));
} else
{buffer.append(ch);
}
{
var G__10398 = (index + 1);
index = G__10398;
continue;
}
}
