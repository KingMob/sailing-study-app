...
{{
var G__14249 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14249;
continue;
}
} else
...
{var pred__14253 = cljs.core._EQ_;var expr__14254 = limit;if(cljs.core.truth_(pred__14253.call(null,1,expr__14254)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14253.call(null,2,expr__14254)))
...
var G__14256 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14257 = (limit__$1 - 1);
var G__14258 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14256;
limit__$1 = G__14257;
parts = G__14258;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14260 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14260))
{var replacement_14261 = temp__4090__auto___14260;buffer.append([cljs.core.str(replacement_14261)].join(''));
} else
{buffer.append(ch);
}
{
var G__14262 = (index + 1);
index = G__14262;
continue;
}
}
