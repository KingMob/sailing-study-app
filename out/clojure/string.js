...
{{
var G__13774 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13774;
continue;
}
} else
...
{var pred__13778 = cljs.core._EQ_;var expr__13779 = limit;if(cljs.core.truth_(pred__13778.call(null,(1),expr__13779)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13778.call(null,(2),expr__13779)))
...
var G__13781 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13782 = (limit__$1 - (1));
var G__13783 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13781;
limit__$1 = G__13782;
parts = G__13783;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13785 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13785))
{var replacement_13786 = temp__4124__auto___13785;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13786)));
} else
{buffer.append(ch);
}
{
var G__13787 = (index + (1));
index = G__13787;
continue;
}
}
