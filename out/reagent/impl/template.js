...
return (function() { 
var G__9439__delegate = function (args){
...
var or__3252__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__9443 = o;
(G__9443[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9444){
var vec__9446 = p__9444;
var id = cljs.core.nth.call(null,vec__9446,(0),null);
var class$ = cljs.core.nth.call(null,vec__9446,(1),null);
var pid = (props["id"]);
...
var pname_9447 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_9447 === "key"))){
(o[pname_9447] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__9450 = jsprops;
(G__9450["defaultValue"] = value);

(G__9450["value"] = null);

(G__9450["onChange"] = ((function (G__9450,on_change,value){
return (function (p1__9448_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9448_SHARP_);
});})(G__9450,on_change,value))
);
...
var or__3252__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__3252__auto__)){
return or__3252__auto__;
} else {
var a1 = (c["props"]["argv"]);
...
var G__9452 = spec;
(G__9452["componentDidUpdate"] = ((function (G__9452){
return (function (){
var c = this;
...
(G__9452["componentWillUnmount"] = ((function (G__9452){
return (function (){
var c = this;
...
var spec = {"displayName": (function (){var or__3252__auto__ = name;
if(cljs.core.truth_(or__3252__auto__)){
return or__3252__auto__;
} else {
...
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__9453_SHARP_,p2__9454_SHARP_);
...
var vec__9456 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9456,(0),null);
var id = cljs.core.nth.call(null,vec__9456,(1),null);
var class$ = cljs.core.nth.call(null,vec__9456,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3252__auto__ = id;
if(cljs.core.truth_(or__3252__auto__)){
return or__3252__auto__;
} else {
...
var vec__9458 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__9458,(0),null);
var id_class = cljs.core.nth.call(null,vec__9458,(1),null);
...
var k_9459 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__9460 = (((k_9459 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9459);
if((k_SINGLEQUOTE__9460 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__9460);
}
...
var n__4139__auto___9461 = a.length;
var i_9462 = (0);
while(true){
if((i_9462 < n__4139__auto___9461)){
(a[i_9462] = reagent.impl.template.as_component.call(null,(a[i_9462]),level_SINGLEQUOTE_));

var G__9463 = (i_9462 + (1));
i_9462 = G__9463;
continue;
} else {
}
