...
var f = (function (){var pred__31350 = cljs.core._EQ_;
var expr__31351 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31350.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31351))){
return ((function (pred__31350,expr__31351){
return (function (p1__31343_SHARP_){
return console.warn(p1__31343_SHARP_);
});
;})(pred__31350,expr__31351))
} else {
if(cljs.core.truth_(pred__31350.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31351))){
return ((function (pred__31350,expr__31351){
return (function (p1__31344_SHARP_){
return console.debug(p1__31344_SHARP_);
});
;})(pred__31350,expr__31351))
} else {
if(cljs.core.truth_(pred__31350.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31351))){
return ((function (pred__31350,expr__31351){
return (function (p1__31345_SHARP_){
return console.error(p1__31345_SHARP_);
});
;})(pred__31350,expr__31351))
} else {
return ((function (pred__31350,expr__31351){
return (function (p1__31346_SHARP_){
return console.log(p1__31346_SHARP_);
});
;})(pred__31350,expr__31351))
}
}
