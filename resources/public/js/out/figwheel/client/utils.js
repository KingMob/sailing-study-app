...
var f = (function (){var pred__29075 = cljs.core._EQ_;
var expr__29076 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29075.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29076))){
return ((function (pred__29075,expr__29076){
return (function (p1__29068_SHARP_){
return console.warn(p1__29068_SHARP_);
});
;})(pred__29075,expr__29076))
} else {
if(cljs.core.truth_(pred__29075.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29076))){
return ((function (pred__29075,expr__29076){
return (function (p1__29069_SHARP_){
return console.debug(p1__29069_SHARP_);
});
;})(pred__29075,expr__29076))
} else {
if(cljs.core.truth_(pred__29075.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29076))){
return ((function (pred__29075,expr__29076){
return (function (p1__29070_SHARP_){
return console.error(p1__29070_SHARP_);
});
;})(pred__29075,expr__29076))
} else {
return ((function (pred__29075,expr__29076){
return (function (p1__29071_SHARP_){
return console.log(p1__29071_SHARP_);
});
;})(pred__29075,expr__29076))
}
}
