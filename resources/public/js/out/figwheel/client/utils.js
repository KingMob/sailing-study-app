...
var f = (function (){var pred__28924 = cljs.core._EQ_;
var expr__28925 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28924.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28925))){
return ((function (pred__28924,expr__28925){
return (function (p1__28917_SHARP_){
return console.warn(p1__28917_SHARP_);
});
;})(pred__28924,expr__28925))
} else {
if(cljs.core.truth_(pred__28924.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28925))){
return ((function (pred__28924,expr__28925){
return (function (p1__28918_SHARP_){
return console.debug(p1__28918_SHARP_);
});
;})(pred__28924,expr__28925))
} else {
if(cljs.core.truth_(pred__28924.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28925))){
return ((function (pred__28924,expr__28925){
return (function (p1__28919_SHARP_){
return console.error(p1__28919_SHARP_);
});
;})(pred__28924,expr__28925))
} else {
return ((function (pred__28924,expr__28925){
return (function (p1__28920_SHARP_){
return console.log(p1__28920_SHARP_);
});
;})(pred__28924,expr__28925))
}
}
