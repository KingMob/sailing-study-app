...
var pred__24779 = cljs.core._EQ_;
...
var G__24782 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24783 = (limit__$1 - (1));
var G__24784 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__24782;
limit__$1 = G__24783;
parts = G__24784;
continue;
...
var temp__4124__auto___24786 = cljs.core.get.call(null,cmap,ch);
if(cljs.core.truth_(temp__4124__auto___24786)){
var replacement_24787 = temp__4124__auto___24786;
buffer.append([cljs.core.str(replacement_24787)].join(''));
} else {
buffer.append(ch);
}

var G__24788 = (index + (1));
index = G__24788;
continue;
}
break;
