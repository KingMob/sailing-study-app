...
var G__20555__delegate = function (type,props,child,children){
if(!(cljs.core.map_QMARK_.call(null,props))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1780568534,null),new cljs.core.Symbol(null,"props","props",2093813254,null)))))].join('')));
}
...
var G__20555 = function (type,props,child,var_args){
var children = null;
...
while (G__20556__i < G__20556__a.length) {G__20556__a[G__20556__i] = arguments[G__20556__i + 3]; ++G__20556__i;}
  children = new cljs.core.IndexedSeq(G__20556__a,0);
} 
return G__20555__delegate.call(this,type,props,child,children);};
G__20555.cljs$lang$maxFixedArity = 3;
G__20555.cljs$lang$applyTo = (function (arglist__20557){
var type = cljs.core.first(arglist__20557);
arglist__20557 = cljs.core.next(arglist__20557);
var props = cljs.core.first(arglist__20557);
arglist__20557 = cljs.core.next(arglist__20557);
var child = cljs.core.first(arglist__20557);
var children = cljs.core.rest(arglist__20557);
return G__20555__delegate(type,props,child,children);
});
...
var G__20558 = null;
if (arguments.length > 3) {
var G__20559__i = 0, G__20559__a = new Array(arguments.length -  3);
while (G__20559__i < G__20559__a.length) {G__20559__a[G__20559__i] = arguments[G__20559__i + 3]; ++G__20559__i;}
G__20558 = new cljs.core.IndexedSeq(G__20559__a,0);
}
return create_element__4.cljs$core$IFn$_invoke$arity$variadic(type,props,child, G__20558);
}
...
var _STAR_non_reactive_STAR_20561 = reagent.impl.component._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_20561;
}});
...
var _STAR_non_reactive_STAR_20563 = reagent.impl.component._STAR_non_reactive_STAR_;
reagent.impl.component._STAR_non_reactive_STAR_ = true;

try{return (React["renderToStaticMarkup"])(reagent.core.as_element.call(null,component));
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_20563;
}});
...
var G__20564__delegate = function (x,rest){
return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__20564 = function (x,var_args){
var rest = null;
if (arguments.length > 1) {
var G__20565__i = 0, G__20565__a = new Array(arguments.length -  1);
while (G__20565__i < G__20565__a.length) {G__20565__a[G__20565__i] = arguments[G__20565__i + 1]; ++G__20565__i;}
  rest = new cljs.core.IndexedSeq(G__20565__a,0);
} 
return G__20564__delegate.call(this,x,rest);};
G__20564.cljs$lang$maxFixedArity = 1;
G__20564.cljs$lang$applyTo = (function (arglist__20566){
var x = cljs.core.first(arglist__20566);
var rest = cljs.core.rest(arglist__20566);
return G__20564__delegate(x,rest);
});
...
var G__20567 = null;
if (arguments.length > 1) {
var G__20568__i = 0, G__20568__a = new Array(arguments.length -  1);
while (G__20568__i < G__20568__a.length) {G__20568__a[G__20568__i] = arguments[G__20568__i + 1]; ++G__20568__i;}
G__20567 = new cljs.core.IndexedSeq(G__20568__a,0);
}
return atom__2.cljs$core$IFn$_invoke$arity$variadic(x, G__20567);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__20569__i < G__20569__a.length) {G__20569__a[G__20569__i] = arguments[G__20569__i + 2]; ++G__20569__i;}
  args = new cljs.core.IndexedSeq(G__20569__a,0);
} 
return wrap__delegate.call(this,value,reset_fn,args);};
wrap.cljs$lang$maxFixedArity = 2;
wrap.cljs$lang$applyTo = (function (arglist__20570){
var value = cljs.core.first(arglist__20570);
arglist__20570 = cljs.core.next(arglist__20570);
var reset_fn = cljs.core.first(arglist__20570);
...
var args = null;
if (arguments.length > 1) {
var G__20571__i = 0, G__20571__a = new Array(arguments.length -  1);
while (G__20571__i < G__20571__a.length) {G__20571__a[G__20571__i] = arguments[G__20571__i + 1]; ++G__20571__i;}
  args = new cljs.core.IndexedSeq(G__20571__a,0);
} 
return partial__delegate.call(this,f,args);};
partial.cljs$lang$maxFixedArity = 1;
partial.cljs$lang$applyTo = (function (arglist__20572){
var f = cljs.core.first(arglist__20572);
