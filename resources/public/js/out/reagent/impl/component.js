...
var _STAR_current_component_STAR_24397 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_24397;
}});
...
var G__24401 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__24401) {
case "componentWillUnmount":
return ((function (G__24401){
return (function (){
var c = this;
...
var or__17594__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
while (G__24404__i < G__24404__a.length) {G__24404__a[G__24404__i] = arguments[G__24404__i + 0]; ++G__24404__i;}
  args = new cljs.core.IndexedSeq(G__24404__a,0);
} 
...
if(cljs.core.truth_((function (){var and__17582__auto__ = wrap;
...
var or__17594__auto__ = (function (){var and__17582__auto__ = cljs.core.fn_QMARK_.call(null,f);
if(and__17582__auto__){
var or__17594__auto__ = (f["displayName"]);
if(cljs.core.truth_(or__17594__auto__)){
return or__17594__auto__;
} else {
return (f["name"]);
...
var or__17594__auto____$1 = (function (){var and__17582__auto__ = (function (){var G__24415 = f;
if(G__24415){
var bit__18268__auto__ = (G__24415.cljs$lang$protocol_mask$partition1$ & (4096));
if((bit__18268__auto__) || (G__24415.cljs$core$INamed$)){
return true;
} else {
return false;
}
...
var render_fun = (function (){var or__17594__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__17594__auto__)){
return or__17594__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__17594__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__17594__auto__)){
return or__17594__auto__;
} else {
...
var G__24417 = o;
(G__24417[cljs.core.name.call(null,k)] = v);
...
return (function() { 
var G__24418__delegate = function (args){
...
var args = cljs.core.seq(arglist__24420);
...
var n = (function (){var G__24422 = reagent.impl.component._STAR_current_component_STAR_;
var G__24422__$1 = (((G__24422 == null))?null:(G__24422["cljsName"])());
return G__24422__$1;
})();
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__18350__auto__ = (function reagent$impl$component$shallow_obj_to_map_$_iter__24427(s__24428){
return (new cljs.core.LazySeq(null,(function (){
var s__24428__$1 = s__24428;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__24428__$1);
if(temp__4126__auto__){
var s__24428__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24428__$2)){
var c__18348__auto__ = cljs.core.chunk_first.call(null,s__24428__$2);
var size__18349__auto__ = cljs.core.count.call(null,c__18348__auto__);
var b__24430 = cljs.core.chunk_buffer.call(null,size__18349__auto__);
if((function (){var i__24429 = (0);
while(true){
if((i__24429 < size__18349__auto__)){
var k = cljs.core._nth.call(null,c__18348__auto__,i__24429);
cljs.core.chunk_append.call(null,b__24430,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null));

var G__24431 = (i__24429 + (1));
i__24429 = G__24431;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24430),reagent$impl$component$shallow_obj_to_map_$_iter__24427.call(null,cljs.core.chunk_rest.call(null,s__24428__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24430),null);
}
} else {
var k = cljs.core.first.call(null,s__24428__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k),(o[k])], null),reagent$impl$component$shallow_obj_to_map_$_iter__24427.call(null,cljs.core.rest.call(null,s__24428__$2)));
}
} else {
return null;
}
...
return iter__18350__auto__.call(null,cljs.core.js_keys.call(null,o));
})());
});
