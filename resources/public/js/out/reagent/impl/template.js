...
if((function (){var G__20510 = v;
if(G__20510){
var bit__13905__auto__ = (G__20510.cljs$lang$protocol_mask$partition1$ & (4096));
if((bit__13905__auto__) || (G__20510.cljs$core$INamed$)){
return true;
} else {
return false;
}
...
while (G__20512__i < G__20512__a.length) {G__20512__a[G__20512__i] = arguments[G__20512__i + 0]; ++G__20512__i;}
  args = new cljs.core.IndexedSeq(G__20512__a,0);
} 
...
var or__13231__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__20515 = o;
(G__20515[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__20516){
var vec__20518 = p__20516;
var id = cljs.core.nth.call(null,vec__20518,(0),null);
var class$ = cljs.core.nth.call(null,vec__20518,(1),null);
var pid = (props["id"]);
...
var pname_20519 = reagent.impl.template.cached_prop_name.call(null,k);
(o[pname_20519] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__13219__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__20522 = jsprops;
(G__20522["defaultValue"] = value);

(G__20522["onChange"] = ((function (G__20522,v,value,on_change){
return (function (p1__20520_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20520_SHARP_);
});})(G__20522,v,value,on_change))
);
...
var vec__20524 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20524,(0),null);
var id = cljs.core.nth.call(null,vec__20524,(1),null);
var class$ = cljs.core.nth.call(null,vec__20524,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,(cljs.core.truth_((function (){var or__13231__auto__ = id;
if(cljs.core.truth_(or__13231__auto__)){
return or__13231__auto__;
} else {
...
var jsprops = {"argv": v};
var key_20529 = (function (){var temp__4128__auto__ = (function (){var G__20527 = cljs.core.meta.call(null,v);
var G__20527__$1 = (((G__20527 == null))?null:reagent.impl.template.get_key.call(null,G__20527));
return G__20527__$1;
})();
if((temp__4128__auto__ == null)){
...
var G__20528_20530 = key_20529;
var G__20528_20531__$1 = (((G__20528_20530 == null))?null:(jsprops["key"] = G__20528_20530));
...
var vec__20535 = reagent.impl.template.cached_parse.call(null,tag);
var comp = cljs.core.nth.call(null,vec__20535,(0),null);
var id_class = cljs.core.nth.call(null,vec__20535,(1),null);
...
var p = (function (){var temp__4128__auto__ = (function (){var G__20536 = cljs.core.meta.call(null,argv);
var G__20536__$1 = (((G__20536 == null))?null:reagent.impl.template.get_key.call(null,G__20536));
return G__20536__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__20537 = (((jsprops == null))?{}:jsprops);
(G__20537["key"] = key);
...
var n__14118__auto___20538 = a.length;
var i_20539 = (0);
while(true){
if((i_20539 < n__14118__auto___20538)){
(a[i_20539] = reagent.impl.template.as_element.call(null,(a[i_20539])));
